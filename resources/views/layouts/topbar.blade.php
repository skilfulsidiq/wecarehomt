    ...
    <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
      <div class="d-flex align-items-center">
        <a href="#" class="btn btn-outline-gray-600 d-inline-flex align-items-center">
                @includeIf('includes.icon',['icon'=>'fa fa-calenda'])
                {{$today}}
            </a>
        <!-- Search form -->
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><b>{{ucwords(Route::currentRouteName())}}</b></li>
        </ol>
        </nav> --}}
          ...
          <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown"
            ...
            <div class="media  d-flex align-items-center">
              ...
              <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                <span
                  class="mb-0 font-small fw-bold text-gray-900">{{  auth()->user()->firstname ? auth()->user()->firstname . ' ' . auth()->user()->lastname : 'User Name'}}</span>
              </div>
            </div>
          </a>
